...
<div class="container">
    ...
    <table>
        <!-- <tr>
            <td>No. Responden</td>
            <td> : </td>
            <td><input class="form-control" name="no"></td>
        </tr> -->
        <tr>
            <td>Satuan Kerja </td>
            <td>:</td>
            <td><input class="form-control" name="satker"></td>
        </tr>
        <tr>
            <td>Unit Kerja</td>
            <td>:</td>
            <td><input class="form-control" name="unit_kerja"></td>
        </tr>
        <tr>
            <td>Nama Pegawai</td>
            <td>:</td>
            <td><input class="form-control" name="nama_pegawai"></td>
        </tr>
        <tr>
            <td>NIP</td>
            <td>:</td>
        ...
        <tr>
            <td>Jabatan</td>
            <td>:</td>
            <td><input class="form-control" name="jabatan"></td>
        </tr>
        <tr>
        ...
        <tr>
            <td>Nama Atasan</td>
            <td>:</td>
            <td><input class="form-control" name="nama_atasan"></td>
        </tr>
        <tr>
            <td>Jabatan</td>
            <td>:</td>
            <td><input class="form-control" name="jabatan_at"></td>
        </tr>
    </table>
    <br><br>
    <center>
    <table border="1">
        <tr>
            <th rowspan="2" style="text-align: center;">Syarat Jabatan</th>
            <th rowspan="2" style="text-align: center;">Kesesuaian Syarat</th>
            <th rowspan="2" style="text-align: center;">Uraian Tugas Jabatan</th>
            <th rowspan="2" style="text-align: center;">Kompetensi</th>
            <th colspan="3" style="text-align: center;">Kompetensi Kerja Nyata</th>
            <th rowspan="2" style="text-align: center;">Diskrepansi Kompetensi Kerja</th>
        </tr>
        <tr>
            <th style="text-align: center;">YB</th>
            <th style="text-align: center;">AT</th>
            <th style="text-align: center;">RK</th>
        </tr>
        <tr>
            <td>Latar Belakang Pendidikan :<br>S2 Hukum <input type="checkbox" name="syarat_jabatan[]" value="pendidikan"/></td>
        ...
        <tr>
            <td>Pendidikan dan Pelatihan yang harus dimiliki: <br> 1. Diklat Pim II
                <input type="checkbox" name="syarat_jabatan[]" value="Diklat Pim II"/> <br>
                2. Pelatihan Manajerial <input type="checkbox" name="syarat_jabatan[]" value="Pelatihan Manajerial"/> <br>
                3. Diklat Legal Drafting <input type="checkbox" name="syarat_jabatan[]" value="Diklat Legal Drafting"/> <br>
                4. Pelatihan Advokasi Hukum <input type="checkbox" name="syarat_jabatan[]" value="Pelatihan Advokasi Hukum"/> <br>
            </td>
            <td><input type="text" style="border: none; outline-style: none;" name="kesesuaian[]"></td>
